# Shabad Library — how to run it

Everything you need day to day: starting it, backing it up, adding shabads,
...
- [Searching](#searching)
- [The swipe deck](#the-swipe-deck)
- [Memorizing](#memorizing)
- [Search quality: picking the summariser model](#search-quality-picking-the-summariser-model)
- [Indexing the library](#indexing-the-library)
